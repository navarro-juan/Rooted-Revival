...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Rooted Revival, where green meets serenity!</p>
      <p className="about-us-content">
        At Rooted Revival, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
